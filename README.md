...
const CHANSIK_SHOI = {
  ...
  직무: "Web Publisher",
  직책: "대리",
  근무기간: "2021.06 ~ 재직중 / 5년차",
  이메일: "ccsik0828@gmail.com",
  코딩스타일: {
    HTML: "BEM",
    CSS: "SCSS & Gulp",
    JavaScript_디자인_패턴: "new Class() or {...}",
  },
  ...
  개인적인: {
    ...
    공부중인분야: ["javascript - Ajax", "React", "Typescript", "Next.js"],
  },
};
```
...
## 저의 기술을 적은 블로그 입니다!
[chanchan_developer.log](https://velog.io/@ckstlr0828/posts) 
